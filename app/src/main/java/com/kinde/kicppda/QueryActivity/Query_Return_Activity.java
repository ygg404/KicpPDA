...
public class Query_Return_Activity extends Activity implements View.OnClickListener{
    ...
    private void bindView()
    {
        ...
        barAdapter = new SimpleAdapter(Query_Return_Activity.this, ScanInfo, R.layout.query_codegrid_item,
